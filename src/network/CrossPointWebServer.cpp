...
constexpr StrId OPT_SHORT_PWR[] = {StrId::STR_IGNORE,         StrId::STR_SLEEP,
...
constexpr WebSettingDef WEB_SETTINGS[] = {
    ...
    WEB_TOGGLE(StrId::STR_ANTI_GHOSTING_EXPERIMENTAL, antiGhostingExperimental, "antiGhostingExperimental",
               StrId::STR_CAT_DISPLAY),
    WEB_TOGGLE(StrId::STR_UI_FOLLOW_ORIENTATION, uiFollowOrientation, "uiFollowOrientation",
               StrId::STR_CAT_DISPLAY),
    ...
    WEB_ENUM(StrId::STR_XTC_STATUS_BAR, xtcStatusBarMode, OPT_XTC_STATUS_BAR, "xtcStatusBarMode",
             StrId::STR_CUSTOMISE_STATUS_BAR),
    // X3 DS3231 clock; the UTC offset is edited on-device (ClockOffsetActivity).
    // Un-toggling "Clock Synced" forces an NTP re-sync on the next sync opportunity.
