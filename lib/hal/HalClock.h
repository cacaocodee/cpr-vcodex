...
class HalClock {
 ...
 public:
  ...
  // Write the current system clock (assumed UTC and already NTP-synced) to the
  // RTC without running SNTP again. Used by the fork's existing NTP flows
  // (Sync Day, KOReader) to keep the chip fresh after any successful sync.
